...
function renderNode(node, parentPath, depth, container) {
  ...
  head.innerHTML = `<span class="rule-id"></span><span class="rule-title-wrap"><span class="rule-title"></span>${node.meta?.read ? '<span class="rule-read"></span>' : ''}</span>`;
  head.querySelector(".rule-id").textContent = node.id;
  head.querySelector(".rule-title").textContent = node.title;
  if (node.meta?.read) head.querySelector(".rule-read").textContent = asText(node.meta.read);
...
const PRESETS = {
  "new": "",
  "ippan": "dBa-2BAbcaMbaaaa-12caaa-9a-a-3aaaabbaa-2aaa-aabaaaaBaabaaacDabeaaaaaAaaaaaaaaaaaaaaaaaaaBaabbaaaaaaaaaaaaaaaaacaaaababaaaaAca-2a-13aaaaaaa-aa-aaaa-3a-aa-2aaa-2a-aaaa-2a-aaaaaaaaaaaaaaa-a-7aa-a-aaa-8aacaaaA-2aaaaaaaa-2aaaa-2aaaaaa-a-a-a-2a-aaaaaa-2aaaaaaaa-2a-2a-2aaaaaaa-aaaaaaa-3a-2a-aaa-a-aa-2aaa-a-3a-2a-a-2aaaaa-5a-a-6a-2aa-4a-a-2a-3aaa-4a-5aa-3aa-3BbaaAaaC-aaa-8a-aaaaaa-2aa-a-a-aaaaaaaaaa-aaaaaaaaa-4fa-aaaaa-aaEaaaaaaaa-a-4aaaaaA-aabBBaa-2aaAacaa-A-11cbbablad-bhimaaedddaaacbcbdbbcabecbcbacbbabdcaeaaaaaaaa-4bbbbaaaaaabbaaa-15a-2aa-7a-35baacccccbbbbbbbbaaaA-3aaaabab-aaAdB-aa-b-cC-ba-bcaaAaaaaaacaaabbaadaBaaaa-6aaaal-2be-aebbabaa",
  "jantama": "dba-2babcambaaaa-12caaa-9a-a-3aaaabbaa-2aaa-aabaaaaBaabaaacDabeaaaaaaaaaaaaaaaaaaaaaaaaaBaabbaaaaaaaaaaaaaaaaacaaaababaaaaAca-2a-13aaaaaaa-aa-aaaa-3a-aa-2aaa-2a-aaaa-2a-aaaaaaaaaaaaaaa-a-7aa-a-aaa-8aacaaaa-2aaaaaaaa-2aaaa-2aaaaaa-a-a-a-2a-aaaaaa-2aaaaaaaa-2a-2a-2aaaaaaa-aaaaaaa-3a-2a-aaa-a-aa-2aaa-a-3a-2a-a-2aaaaa-5a-a-6a-2aa-4a-a-2a-3aaa-4a-5aa-3aa-3bbaaAaaC-aaa-8a-aaaaaa-2aa-a-a-aaaaaaaaaa-aaaaaaaaa-4fa-aaaaa-aaEaaaaaaaa-a-4aaaaaA-aabBBaa-2aaAacaa-a-11cbcablad-bhimaaedddaaacbcbdbbcabecbcbacbbabdcaeaaaaaaaa-4bbbbaaaaaabbaaa-15a-2aa-7a-35baacccccbbbbbbbbaaaA-3aaaabab-aaAdb-aa-b-cc-ba-bcaaAaaaaaacaaabbaadaBaaaa-6aaaal-2be-aebbabaa"
};
document.querySelectorAll(".home-card").forEach(card => {
  card.addEventListener("click", () => {
    ...
    flagged.clear();
    if (valueString) applyValueString(expandRuns(valueString));
